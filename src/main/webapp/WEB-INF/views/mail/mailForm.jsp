...
<div class="container">
	...
	<form name="myform" method="post" class="was-validated">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="toMail" name="toMail" placeholder="받는 사람 메일주소를 입력하세요" required/>
			<div class="invalid-feedback">받는 사람의 메일주소는 필수 항목 입니다.</div>
		...
		<div class="form-group">
			...
			<div class="invalid-feedback">메일제목은 필수 항목 입니다.</div>
		...
		<div class="form-group">
			...
			<div class="invalid-feedback">메일내용은 필수 항목 입니다.</div>
