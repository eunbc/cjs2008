...
<c:forEach var="jichul" items="${jichulArr}">
	...
	<div class="container-fluid" style="margin-top: 30px;margin-bottom: 30px;width:90%;">
		...
		<div class="row">
		  <div class="col-sm-12" style="background-color:#1c140d;text-align: center;">
		  	<button class="btn btn-block" style="background-color: #ff4e50;" onclick="location.href='${contextPath}/study/calendar'" >
		  		<font style="font-size: 2em;"><i class="fa fa-home">Today</i></font>
		  	</button>
		  </div>
		</div>
	</div>
